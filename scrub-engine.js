...
function mountScrollWorld(container, config) {
  ...
  function loadClip(s) {
    // Scroll-scrubbing is USER-DRIVEN (nothing animates unless you scroll), so unlike
    // autoplay it's allowed even under prefers-reduced-motion — the scrubbed camera IS the
    // content of this page. Auto-motion decorations (drifting particles, pulsing hint) stay
    // off under reduce-motion (see seedParticles / CSS below).
